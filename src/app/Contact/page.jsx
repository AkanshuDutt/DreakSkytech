  ...
  return (
    <>
      ...
      <div className="relative z-10 pt-20 pb-12 px-4 text-center">
        ...
        >
          <h1 className="text-5xl md:text-5xl font-black mt-1 mb-3">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-15">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <div
              className="relative bg-white/10 backdrop-blur-3xl rounded-3xl p-10 mt-0 border border-white/20 shadow-2xl hover:shadow-purple-500/20 transition-all duration-500"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="relative group">
                      ...
                      <input
                        ...
                        maxLength={10}
                        className={`relative w-full pl-12 pr-4 py-4 bg-white/5 border ${errors.phone ? 'border-red-400' : 'border-white/20'} rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-green-400 focus:bg-white/10 transition-all duration-300 hover:bg-white/8`}
                      />
            ...
            <div className="bg-white/5 backdrop-blur-2xl rounded-3xl p-8 border border-white/20 hover:border-blue-400/40 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20">
              ...
              <div className="relative p-6 bg-white/5 rounded-2xl border border-blue-400/20">
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  We guarantee a response within <span className="text-green-400 font-bold text-xl">24 hours</span> for all inquiries.
                </p>
